  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="6">
            <a-form-item :label="$t('ErpMaterialIncomingInspection.queryTime')">
          ...
          <a-col :md="6" :sm="6">
            <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
              ...
              <download-excel
                ...
                type="xls"
                name="ErpMaterialIncomingInspectionList.xls"
              >
    ...
    <!-- 表单区域 -->
    <erp-material-incoming-inspection-modal
      ref="modalForm"
      @ok="modalFormOk"
    ></erp-material-incoming-inspection-modal>
  </a-card>
...
<script>
import ErpMaterialIncomingInspectionModal from './modules/ErpMaterialIncomingInspectionModal'
...
export default {
  name: 'ErpMaterialIncomingInspectionList',
  mixins: [JeecgListMixin],
  components: {
    JEllipsis,
    ErpMaterialIncomingInspectionModal,
  },
  data() {
    return {
      description: 'ErpMaterialIncomingInspection管理',
      // 新增修改按钮是否显示
      ...
      columns: [
        ...
        {
          title: this.$t('ErpMaterialIncomingInspection.stockCode'),
          align: 'center',
          width: 100,
          dataIndex: 'stockCode',
        },
        ...
        {
          title: this.$t('ErpMaterialIncomingInspection.supplierId'),
          align: 'center',
          width: 100,
          dataIndex: 'supplier',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.incomingBatches'),
          align: 'center',
          width: 100,
          dataIndex: 'incomingBatches',
        },

        {
          title: this.$t('ErpMaterialIncomingInspection.incomingNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'incomingNumber',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.inspectNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'inspectNumber',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.qualifiedNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'qualifiedNumber',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.unitCode'),
          align: 'center',
          width: 100,
          dataIndex: 'unitCode',
          customRender: function (t, r, index) {
        ...
        {
          title: this.$t('ErpMaterialIncomingInspection.passPercent') + ' (%)',
          align: 'center',
          width: 120,
          dataIndex: 'passPercent',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.inspectResult'),
          align: 'center',
          width: 100,
        ...
        {
          title: this.$t('ErpMaterialIncomingInspection.operator'),
          align: 'center',
          width: 100,
          dataIndex: 'operator',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.incomingTime'),
          align: 'center',
          width: 150,
          dataIndex: 'incomingTime',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.inspectTime'),
          align: 'center',
          width: 150,
          dataIndex: 'inspectTime',
        },
        {
          title: this.$t('ErpMaterialIncomingInspection.importTime'),
          align: 'center',
          width: 150,
  ...
  created() {
    ...
    let config = this.$store.getters.userInfo.sysDept.config.erpMaterialIncomingInspectionListFiled
  ...
  methods: {
    ...
    showAdd(item) {
      return this.$store.getters.userInfo.permissions.includes('erpMaterialIncomingInspection:add')
    },
    showExport() {
      return this.$store.getters.userInfo.permissions.includes('erpMaterialIncomingInspection:export')
    },
    showEdit(item) {
      return this.$store.getters.userInfo.permissions.includes('erpMaterialIncomingInspection:update')
    },
    showDelete(item) {
      return this.$store.getters.userInfo.permissions.includes('erpMaterialIncomingInspection:delete')
    },
