  ...
  <div class="card-container">
    <a-card :bordered="false">
          ...
          <a-row :gutter="[24, 8]" align="middle" justify="space-between" type="flex">
            <a-col>
              <a-row :gutter="[24, 8]" align="middle" type="flex">
                <a-col>
                  <a-form-item :label="$t('ErpOemProductInspection.stockName')">
      ...
      <section class="gap--common bordered--wt section--summary">
        <a-descriptions layout="vertical" :title="$t('InspectStatistics.oemSubtotal')" :column="2">
...
export default {
  ...
  data() {
    return {
      ...
      option: {
        ...
        title: { text: this.$t('InspectStatistics.oemInspectStatisticsTitle') },
        // toolbox: {
        //   feature: {
      ...
      pieoption: {
        title: { text: this.$t('InspectStatistics.oemInspectResult') },
        tooltip: {
          trigger: 'item',
        },
        legend: {
  ...
  methods: {
    moment,
    async loadData() {
      let res = await API.oemInspectStatistics(this.condition)
