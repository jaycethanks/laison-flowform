    ...
    <a-spin :spinning="confirmLoading">
      ...
      >
        <a-row>
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.orderId')"
            prop="orderId"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.stockName')"
            prop="stockCode"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.supplierId')"
            prop="supplierId"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.inspectScheme')"
            prop="inspectScheme"
            v-if="showFiled('inspectScheme')"
          >
            <LaisonErpConfig
              :disabled="isDetail"
              :conditions="{ configCode: 'jyfa' }"
              v-model="model.inspectScheme"
            />
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.orderNumber')"
            prop="orderNumber"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.inspectTime')"
            prop="inspectTime"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.submittedInspectNumber')"
          ...
          >
            <a-input-number
              ...
              :min="0"
              :precision="0"
              placeholder="submittedInspectNumber"
              style="width: 100%"
            />
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.inspectNumber')"
            prop="inspectNumber"
          ...
          >
            <a-input-number
              ...
              :min="0"
              :precision="0"
              placeholder="inspectNumber"
              style="width: 100%"
            />
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.qualifiedNumber')"
          ...
          >
            <a-input-number
              ...
              :min="0"
              :precision="0"
              placeholder="qualifiedNumber"
              style="width: 100%"
            />
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.unitCode')"
            prop="unitCode"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.passPercent')"
            prop="passPercent"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.inspectResult')"
            prop="inspectResult"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.unqualifiedReviewConclusion')"
          ...
          >
            <a-input
              ...
              prop="unqualifiedReviewConclusion"
              placeholder="unqualifiedReviewConclusion"
            ></a-input>
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.badCategory')"
            prop="badCategory"
          ...
          <a-form-model-item
            :label="$t('ErpOemProductInspection.badDescription')"
            prop="badDescription"
          ...
          >
            <a-input
              ...
              prop="badDescription"
              placeholder="badDescription"
            ></a-input>
          </a-form-model-item>
          <a-form-model-item
            :label="$t('ErpOemProductInspection.inspectDescription')"
          ...
          >
            <a-input
              ...
              prop="inspectDescription"
              placeholder="inspectDescription"
            ></a-input>
          </a-form-model-item>
        </a-row>
      </a-form-model>
...
import API from '@/api/ErpOemProductInspection'
...
export default {
  name: 'ErpOemProductInspectionModal',
        ...
        id: [
          {
            validator: (rule, value, callback) => {
              ...
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.idError')))
              } else {
                callback()
              }
            },
        ...
        orderId: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.orderIdError')))
              } else {
                callback()
              }
            },
        ...
        stockCode: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.stockCodeError')))
              } else {
                callback()
              }
            },
        ...
        supplierId: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.supplierIdError')))
              } else {
                callback()
              }
            },
        ...
        inspectScheme: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.inspectSchemeError')))
              } else {
                callback()
              }
            },
        ...
        orderNumber: [
          {
            validator: (rule, value, callback) => {
              ...
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.orderNumberError')))
              } else {
                callback()
              }
            },
        ...
        submittedInspectNumber: [
          {
            validator: (rule, value, callback) => {
              let error = value == undefined || value == null
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.submittedInspectNumberError')))
              } else {
                callback()
              }
            },
        ...
        inspectNumber: [
          {
            validator: (rule, value, callback) => {
              let error = value == undefined || value == null
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.inspectNumberError')))
              } else {
                callback()
              }
            },
        ...
        qualifiedNumber: [
          {
            validator: (rule, value, callback) => {
              let error = value == undefined || value == null
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.qualifiedNumberError')))
              } else {
                callback()
              }
            },
        ...
        unitCode: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.unitCodeError')))
              } else {
                callback()
              }
            },
        ...
        passPercent: [
          {
            validator: (rule, value, callback) => {
              let error = value == undefined || value == null
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.passPercentError')))
              } else {
                callback()
              }
            },
        ...
        inspectResult: [
          {
            validator: (rule, value, callback) => {
              let error = value == undefined || value == null
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.inspectResultError')))
              } else {
                callback()
              }
            },
        ...
        unqualifiedReviewConclusion: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.unqualifiedReviewConclusionError')))
              } else {
                callback()
              }
            },
        ...
        badCategory: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.badCategoryError')))
              } else {
                callback()
              }
            },
        ...
        badDescription: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.badDescriptionError')))
              } else {
                callback()
              }
            },
        ...
        inspectDescription: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.inspectDescriptionError')))
              } else {
                callback()
              }
            },
        ...
        deptId: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.deptIdError')))
              } else {
                callback()
              }
            },
        ...
        operatorId: [
          {
            validator: (rule, value, callback) => {
              ...
              let error = value == undefined || value == null || !reg.test(value)
              if (error) {
                callback(new Error(this.$t('ErpOemProductInspection.operatorIdError')))
              } else {
                callback()
              }
            },
  ...
  methods: {
    ...
    showFiled(filedName) {
      let config = this.$store.getters.userInfo.sysDept.config.erpOemProductInspectionAddFiled
