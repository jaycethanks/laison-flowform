  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="6">
            <a-form-item :label="$t('ErpOemProductInspection.queryTime')">
          ...
          <a-col :md="6" :sm="6">
            <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
              ...
              <download-excel
                ...
                type="xls"
                name="ErpOemProductInspectionList.xls"
              >
    ...
    <!-- 表单区域 -->
    <erp-oem-product-inspection-modal ref="modalForm" @ok="modalFormOk"></erp-oem-product-inspection-modal>
  </a-card>
</template>

<script>
import ErpOemProductInspectionModal from './modules/ErpOemProductInspectionModal'
...
export default {
  name: 'ErpOemProductInspectionList',
  mixins: [JeecgListMixin],
  components: {
    JEllipsis,
    ErpOemProductInspectionModal,
  },
  data() {
    return {
      description: 'ErpOemProductInspection管理',
      // 新增修改按钮是否显示
      ...
      columns: [
        ...
        {
          title: this.$t('ErpOemProductInspection.orderId'),
          align: 'center',
          width: 100,
          dataIndex: 'orderId',
        },
        {
          title: this.$t('ErpOemProductInspection.stockCode'),
          align: 'center',
          width: 100,
          dataIndex: 'stockCode',
        },
        ...
        {
          title: this.$t('ErpOemProductInspection.supplierId'),
          align: 'center',
          width: 100,
          dataIndex: 'supplier',
        },
        ...
        {
          title: this.$t('ErpOemProductInspection.orderNumber'),
          align: 'center',
          width: 100,
        ...
        {
          title: this.$t('ErpOemProductInspection.submittedInspectNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'submittedInspectNumber',
        },
        {
          title: this.$t('ErpOemProductInspection.inspectNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'inspectNumber',
        },
        {
          title: this.$t('ErpOemProductInspection.qualifiedNumber'),
          align: 'center',
          width: 100,
          dataIndex: 'qualifiedNumber',
        },
        {
          title: this.$t('ErpOemProductInspection.unitCode'),
          align: 'center',
          width: 100,
          dataIndex: 'unitCode',
          customRender: function (t, r, index) {
        ...
        {
          title: this.$t('ErpOemProductInspection.passPercent') + ' (%)',
          align: 'center',
          width: 130,
          dataIndex: 'passPercent',
        },
        {
          title: this.$t('ErpOemProductInspection.inspectResult'),
          align: 'center',
          width: 100,
        ...
        {
          title: this.$t('ErpOemProductInspection.badDescription'),
          align: 'center',
          width: 150,
          dataIndex: 'badDescription',
        },
        {
          title: this.$t('ErpOemProductInspection.inspectDescription'),
          align: 'center',
          width: 200,
        ...
        {
          title: this.$t('ErpOemProductInspection.operator'),
          align: 'center',
          width: 100,
          dataIndex: 'operator',
        },
        {
          title: this.$t('ErpOemProductInspection.inspectScheme'),
          align: 'center',
          width: 130,
          dataIndex: 'inspectScheme',
          customRender: function (t, r, index) {
            let props = {}
            props['value'] = r.inspectScheme
            props['conditions'] = { configCode: 'jyfa' }
            props['disabled'] = true
            let a = <LaisonErpConfig {...{ props }} />
            return a
          },
        ...
        {
          title: this.$t('ErpOemProductInspection.inspectTime'),
          align: 'center',
          width: 150,
          dataIndex: 'inspectTime',
        },
        {
          title: this.$t('ErpOemProductInspection.importTime'),
          align: 'center',
          width: 150,
  ...
  created() {
    ...
    let config = this.$store.getters.userInfo.sysDept.config.erpOemProductInspectionListFiled
  ...
  methods: {
    ...
    showAdd(item) {
      return this.$store.getters.userInfo.permissions.includes('erpOemProductInspection:add')
    },
    showExport() {
      return this.$store.getters.userInfo.permissions.includes('erpOemProductInspection:export')
    },
    showEdit(item) {
      return this.$store.getters.userInfo.permissions.includes('erpOemProductInspection:update')
    },
    showDelete(item) {
      return this.$store.getters.userInfo.permissions.includes('erpOemProductInspection:delete')
    },
