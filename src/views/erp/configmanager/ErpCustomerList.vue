  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="6">
            <a-form-item :label="$t('ErpCustomer.name')">
              <a-input v-model="pageInfo.condition.name" :placeholder="$t('ErpCustomer.name')"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="6">
          ...
          <a-col :md="6" :sm="6">
            <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
              ...
              <download-excel v-if="showExport()" class="export-excel-wrapper" :data="exportDatas" :fields="exportJsonFiled" :before-generate="startDownload" type="xls" name="ErpCustomerList.xls">
    ...
    <!-- 表单区域 -->
    <erp-customer-modal ref="modalForm" @ok="modalFormOk"></erp-customer-modal>
  </a-card>
</template>

<script>
import ErpCustomerModal from './modules/ErpCustomerModal'
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        // {
        //   title: this.$t('ErpCustomer.id'),
        //   align: 'left',
        //   dataIndex: 'id'
        // },
        {
          title: this.$t('ErpCustomer.customerNo'),
          align: 'left',
          dataIndex: 'customerNo',
        },
        {
          title: this.$t('ErpCustomer.name'),
          align: 'left',
          dataIndex: 'name',
        },

        {
          title: this.$t('ErpCustomer.briefIntro'),
          align: 'left',
          dataIndex: 'briefIntro',
        },
        {
          title: this.$t('ErpCustomer.levelId'),
          align: 'left',
          dataIndex: 'level',
        },
        {
          title: this.$t('ErpCustomer.currencySymbol'),
          align: 'left',
        ...
        // {
        //   title: this.$t('ErpCustomer.signingStartTime'),
        //   align: 'left',
        //   dataIndex: 'signingStartTime'
        // },
        // {
        //   title: this.$t('ErpCustomer.signingEndTime'),
        //   align: 'left',
        //   dataIndex: 'signingEndTime'
        // },
        {
          title: this.$t('ErpCustomer.personalInfoId'),
          align: 'left',
          dataIndex: 'personalInfoName',
        },
        {
          title: this.$t('ErpCustomer.salesmanId'),
          align: 'left',
          dataIndex: 'salesmanId',
          customRender: function (t, r, index) {
            return t && t.indexOf('_') > -1 ? t.split('_')[1] : t
          },
        },
        {
          title: this.$t('ErpCustomer.financeId'),
          align: 'left',
          dataIndex: 'financeName',
        },

        // {
        //   title: this.$t('ErpCustomer.belongDeptId'),
        //   align: 'left',
        //   dataIndex: 'belongDeptName'
        // },
        {
          title: this.$t('ErpCustomer.status'),
          align: 'left',
          dataIndex: 'status',
          customRender: function (t, r, index) {
            return t ? '启用' : '禁用'
        ...
        {
          title: this.$t('ErpCustomer.delFlag'),
          align: 'left',
          dataIndex: 'delFlag',
          customRender: function (t, r, index) {
            return t ? '是' : '否'
        ...
        {
          title: this.$t('ErpCustomer.createBy'),
          align: 'left',
          dataIndex: 'createName',
        },
        {
          title: this.$t('ErpCustomer.createTime'),
          align: 'left',
          dataIndex: 'createTime',
        },
        {
          title: this.$t('ErpCustomer.updateBy'),
          align: 'left',
          dataIndex: 'updateName',
        },
        {
          title: this.$t('ErpCustomer.updateTime'),
          align: 'left',
          dataIndex: 'updateTime',
        },
        {
          title: this.$t('ErpCustomer.deptId'),
          align: 'left',
          dataIndex: 'deptName',
        },
        {
  ...
  created() {
    ...
    let config = this.$store.getters.userInfo.sysDept.config.erpCustomerListFiled
  ...
  methods: {
    ...
    showAdd(item) {
      return this.$store.getters.userInfo.permissions.includes('erpCustomer:add')
    },
    showExport() {
      return this.$store.getters.userInfo.permissions.includes('erpCustomer:export')
    },
    showEdit(item) {
      return this.$store.getters.userInfo.permissions.includes('erpCustomer:update')
    },
    showDelete(item) {
      return this.$store.getters.userInfo.permissions.includes('erpCustomer:delete')
    },
