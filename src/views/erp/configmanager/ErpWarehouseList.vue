  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
                                                                                                                                                                                                                                         	<a-col :md="6" :sm="6">
                <a-form-item :label="$t('ErpWarehouse.queryTime')" >
...
<!--      </div>-->
    ...
    <!-- 表单区域 -->
    <erp-warehouse-modal ref="modalForm" @ok="modalFormOk"></erp-warehouse-modal>
  </a-card>
</template>

<script>
  import ErpWarehouseModal from './modules/ErpWarehouseModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'
  import JEllipsis from "@/components/jeecg/JEllipsis";
  import API   from '@/api/ErpWarehouse'
  import moment from 'moment';
  export default {
    name: "ErpWarehouseList",
    ...
    data() {
      return {
        ...
        columns: [
            ...
            {
                title: this.$t('ErpWarehouse.id'),
                align: "center",
                dataIndex: 'id'
            },
            {
                title: this.$t('ErpWarehouse.name'),
                align: "center",
                dataIndex: 'name'
            },
            {
                title: this.$t('ErpWarehouse.belongDeptId'),
                align: "center",
                dataIndex: 'belongDeptId'
            },
            {
                title: this.$t('ErpWarehouse.factoryId'),
                align: "center",
                dataIndex: 'factoryId'
            },
            {
                title: this.$t('ErpWarehouse.telephone'),
                align: "center",
                dataIndex: 'telephone'
            },
            {
                title: this.$t('ErpWarehouse.director'),
                align: "center",
                dataIndex: 'director'
            },
            {
                title: this.$t('ErpWarehouse.calModeId'),
                align: "center",
                dataIndex: 'calModeId'
            },
            {
                title: this.$t('ErpWarehouse.warehouseAttrId'),
                align: "center",
                dataIndex: 'warehouseAttrId'
            },
            {
                title: this.$t('ErpWarehouse.regionCode'),
                align: "center",
                dataIndex: 'regionCode'
            },
            {
                title: this.$t('ErpWarehouse.address'),
                align: "center",
                dataIndex: 'address'
            },
            {
                title: this.$t('ErpWarehouse.remarks'),
                align: "center",
                dataIndex: 'remarks'
            },
            {
                title: this.$t('ErpWarehouse.status'),
                align: "center",
                dataIndex: 'status'
            },
            {
                title: this.$t('ErpWarehouse.delFlag'),
                align: "center",
                dataIndex: 'delFlag'
            },
            {
                title: this.$t('ErpWarehouse.createBy'),
                align: "center",
                dataIndex: 'createBy'
            },
            {
                title: this.$t('ErpWarehouse.createTime'),
                align: "center",
                dataIndex: 'createTime'
            },
            {
                title: this.$t('ErpWarehouse.updateBy'),
                align: "center",
                dataIndex: 'updateBy'
            },
            {
                title: this.$t('ErpWarehouse.updateTime'),
                align: "center",
                dataIndex: 'updateTime'
            },
            {
                title: this.$t('ErpWarehouse.deptId'),
                align: "center",
                dataIndex: 'deptId'
            },
            {
    ...
    created() {
     ...
     let config = this.$store.getters.userInfo.sysDept.config.erpWarehouseListFiled
    ...
    methods: {
      ...
      showAdd(item){
         return  this.$store.getters.userInfo.permissions.includes('erpWarehouse:add')
      },
      showExport(){
         return  this.$store.getters.userInfo.permissions.includes('erpWarehouse:export')
      },
      showEdit(item){
         return  this.$store.getters.userInfo.permissions.includes('erpWarehouse:update')
      },
      showDelete(item){
         return  this.$store.getters.userInfo.permissions.includes('erpWarehouse:delete')
      },
