...
export default {
  ...
  methods: {
    ...
    /**
     * ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
     * record 是整个流程的数据，在编辑时，需要将 BpmnProcessFormDesigner 进行数据初始化
     * 而 BpmnProcessFormDesigner 由三个主要模块组成， 分别时 k-form-design 表单设计、 bpmn 流程设计、 以及流程发布
     * 这三个模块的数数据来源都不统一，
     * 简单的说：
     ...
     * 2. bpmn 流程设计， 其初始化接口，在 "src\views\erp\formdesign\BpmnProcessFormDesigner\BpmnDesigner.vue ---- xmlString"
     * 所以需要这里需要将当前record的数据传入， 且需要处理为新增的时候，将其置空操作，
     * 此外需要特别注意的是，字段的控制， 人员组织选择控件都需要初始化。
     * 3. FormDesignPublish 也需要传入初始化数据
     *
     * 方便和可读性起见， 这里会将数据传入 BpmnProcessFormDesigner ，然后做简单处理后，直接用props 传值，处理2，3 , 并直接set 1, 具体的数据处理，分散到各层级组件。
     * ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
     */
    // }
  },
