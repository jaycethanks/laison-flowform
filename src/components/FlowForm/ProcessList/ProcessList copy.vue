  ...
  <div class="form-list-wrapper">
    ...
    <a-collapse :bordered="false">
      ...
      <a-collapse-panel v-for="group in list" :key="group.groupName" :header="group.groupName" :style="customStyle">
        <a-table :columns="columns" :data-source="group.formTemplates" rowKey="designKey">
          <template slot="formDesignId">
            <!-- <div class="icon-box" :style="{ backgroundColor: group.formTemplates.designColor }"> -->
            <img style="width: 48px; height: 48px" :src="getIcon(group.formTemplates.designIcon)" alt="" />
            <!-- </div> -->
          </template>
