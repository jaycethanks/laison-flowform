<template>
  ...
  > -->
    <div class="org-container">
      ...
      >
        ...
        >
          ...
          >
            <el-radio-button v-if="!disableDept" label="dept">{{
              $t("orgSelectComp.dept")
            }}</el-radio-button>
            <el-radio-button v-if="!disableRole" label="role">{{
              $t("orgSelectComp.role")
            }}</el-radio-button>
            <el-radio-button v-if="!disablePerson" label="person">{{
              $t("orgSelectComp.people")
            }}</el-radio-button>
          </el-radio-group>
          <el-input
            style="width: 200px"
    ...
    <span slot="footer" class="dialog-footer" v-if="selectable">
      <el-button :size="elementSize" @click="handleClose">{{
        $t("common.cancelText")
      }}</el-button>
